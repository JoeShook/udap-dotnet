...
//
// namespace Udap.Server.Configuration.Model;
// public class SignedSoftwareStatementBuilderNew<T> where T: class
// {
//     private readonly X509Certificate2 _certificate;
//     private readonly T _document;
//
//     private SignedSoftwareStatementBuilderNew(X509Certificate2 certificate, T document)
//     {
//         _certificate = certificate;
//         _document = document;
//     }
//
//     public static SignedSoftwareStatementBuilderNew<T> CreateNew(X509Certificate2 certificate, T document)
//     {
//         return new SignedSoftwareStatementBuilderNew<T>(certificate, document);
//     }
//      
//     //
//     // No With items...
...
//         var encodedPayload = Base64UrlEncoder.Encode(JsonSerializer.Serialize(_document));
//         
