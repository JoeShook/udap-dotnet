...
/// <summary>
/// Implementation of IClientStore EF provider.
/// </summary>
...
public class ClientStore : IClientStore
{
    ...
    /// The DbContext.
    /// </summary>
    protected readonly IUdapDbAdminContext Context;
    ...
    public ClientStore(IUdapDbAdminContext context, ILogger<ClientStore> logger, ICancellationTokenProvider cancellationTokenProvider)
    {
    ...
    {
        using var activity = Udap.Common.Tracing.StoreActivitySource.StartActivity("ClientStore.FindClientById");
        activity?.SetTag(Udap.Common.Tracing.Properties.ClientId, clientId);
