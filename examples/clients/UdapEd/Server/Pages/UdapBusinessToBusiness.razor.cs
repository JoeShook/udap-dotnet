...
public partial class UdapBusinessToBusiness
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            if (_loginCallbackResult != null)
            {
                await AppState.SetPropertyAsync(this, nameof(AppState.LoginCallBackResult), _loginCallbackResult, true, false);
            }
        }
    ...
    public string LoginCallback(bool reset = false)
    {
        ...
        if (!string.IsNullOrEmpty(uri.Query))
        {
            ...
            _loginCallbackResult = new LoginCallBackResult
            {
    ...
    private async Task BuildAccessTokenRequest ()
    {
        ...
        if (AppState.Oauth2Flow == Oauth2FlowEnum.authorization_code)
        {
            ...
            var requestToken = AccessService
